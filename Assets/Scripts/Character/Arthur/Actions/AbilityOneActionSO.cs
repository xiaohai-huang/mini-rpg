...
namespace Xiaohai.Character.Arthur
{
    [CreateAssetMenu(
        ...
        menuName = "State Machines/Actions/Arthur/Ability One Action"
    )]
    ...
    public class AbilityOneAction : StateAction
    {
        ...
        private static readonly int ABILITY_ONE_PREPARE_ANIMATION_ID = Animator.StringToHash(
            "Ability One Preparation"
        );
        ...
        public override void OnStateEnter()
        {
            ...
            effect.Init(
                ...
                OriginSO.EnhancedBasicAttackRange
            );
