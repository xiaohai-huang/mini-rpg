...
namespace Xiaohai.Character.Arthur
{
    [CreateAssetMenu(
        ...
        menuName = "State Machines/Actions/Arthur/Ability Two Action"
    )]
    ...
    public class AbilityTwoAction : StateAction
    {
        ...
        public override void OnStateEnter()
        {
            ...
            effect.Init(
                OriginSO.SHIELD_PHYSICAL_DAMAGE_AMOUNT,
                OriginSO.SHIELDS_DURATION,
                OriginSO.Shields.Value.GetComponent<Shields>()
            );
