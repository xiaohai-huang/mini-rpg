...
{
    [CreateAssetMenu(
        fileName = "Can Do Basic Attack Condition",
        menuName = "State Machines/Conditions/Marco Polo/Can Do Basic Attack Condition"
    )]
    ...
    {
        protected new CanDoBasicAttackConditionSO OriginSO =>
            (CanDoBasicAttackConditionSO)base.OriginSO;
