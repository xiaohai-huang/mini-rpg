...
[CreateAssetMenu(
    fileName = "SetBoolAnimatorParameterActionSO",
    menuName = "State Machines/Actions/Set Bool Animator Param Action"
)]
...
{
    protected new SetBoolAnimatorParameterActionSO OriginSO =>
        (SetBoolAnimatorParameterActionSO)base.OriginSO;
