...
namespace UOP1.StateMachine.Editor
{
    internal static class ContentStyle
    {
        ...
        internal static void Initialize()
        {
            ...
            DarkGray = EditorGUIUtility.isProSkin
                ? new Color(0.283f, 0.283f, 0.283f)
                : new Color(0.7f, 0.7f, 0.7f);
            LightGray = EditorGUIUtility.isProSkin
            ...
            GUIStyleState guiStyleStateNormal = EditorGUIUtility
