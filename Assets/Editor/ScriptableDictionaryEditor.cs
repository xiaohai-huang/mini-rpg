...
namespace ScriptableDictionaries.Editor
{
    ...
    public class ScriptableDictionaryEditor : UnityEditor.Editor
    {
        ...
        {
            public const string PropNameKeys = "keys",
                PropNameValues = "values";

            public const float LineIconWidth = 17;
        }
        ...
        private struct Contents
        {
            ...
            public static void Load()
            {
                ...
                IconDuplicateKey = new GUIContent(
                    warnIcon,
                    "Conflict: please remove/change duplicate key."
                );
                IconNullKey = new GUIContent(
                    warnIcon,
                    "Conflict: null is an invalid value for a key."
                );
            }
        }
        ...
        {
            public static Conflict DuplicateKey =>
                new Conflict(Contents.IconDuplicateKey, new Color(1f, 0.85f, 0.46f));
            public static Conflict NullKey =>
                new Conflict(Contents.IconNullKey, new Color(1f, 0.85f, 0.46f));
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new HorizontalScope())
            {
                ...
                LabelField(
                    $"Values ({_properties.values.arrayElementType})",
